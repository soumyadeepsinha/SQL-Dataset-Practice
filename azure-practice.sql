...
-- Show product data
SELECT [ProductID], [Name], [ProductModelID], [ListPrice], [SellStartDate], [SellEndDate], [DiscontinuedDate]
  FROM [SalesLT].[Product]

-- Show sales order data
SELECT [CustomerID], [SalesOrderID], [ShipMethod], [DueDate], [TotalDue]
...
SELECT soh.[CustomerID], 
        ...
        sod.[SalesOrderID], sod.[ProductID], sod.[OrderQty], soh.[TotalDue]
